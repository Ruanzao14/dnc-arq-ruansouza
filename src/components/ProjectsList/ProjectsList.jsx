...
function ProjectsList() {
  ...
  //Se você abrir o inspecionar e ir no console, vai ver que esse componente ta gerando um erro que ta dando um loop infinito, porque?
          ...
          ? projects.map((project) => (
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: project.thumb }}
                ></div>
                <h3>{project.title}</h3>
